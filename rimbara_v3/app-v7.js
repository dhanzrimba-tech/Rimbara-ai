...
async function connect(){
 ...
 }catch(e){console.error(e);setState('Could not start live voice');$('connect').disabled=false;if(micStream)micStream.getTracks().forEach(t=>t.stop());alert('RIMBARA AI V7.1: '+e.message+'\n\nPastikan server berjalan, API key sudah diatur, dan browser mengizinkan mikrofon.');}
}
